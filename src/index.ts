...
export namespace Duck {
  ...
  export namespace TypeClasses {
    ...
    export namespace Models {
      ...
      export type Texture<t extends Duck.Types.Texture.Type> = TextureClass<t>;
  ...
  export namespace Types {
    ...
    export namespace Collider {
      export type ShapeString = 'rect' | 'circle' | 'roundrect' | 'sprite';
    ...
    export namespace GamepadInput {
      ...
      export type Mapping = typeof XboxMapping | typeof PlaystationMapping;
